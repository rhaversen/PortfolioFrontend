			...
			<div className="min-h-screen text-foreground antialiased [font-variant-numeric:tabular-nums] [&_a]:decoration-transparent [&_a]:transition-colors [&_a]:duration-150 [&_a:hover]:decoration-current">
				<section className="w-full border-y border-border bg-card/80">
					<div className="max-w-4xl mx-auto px-6 py-16 sm:py-20">
						...
						<h1 className="text-4xl sm:text-5xl font-semibold tracking-tight leading-tight mt-4">Loading...</h1>
					</div>
				</section>
			</div>
		)
			...
			<section className="w-full border-y border-border bg-card/80">
				<div className="max-w-4xl mx-auto px-6 py-16 sm:py-20">
					...
					<h1 className="text-4xl sm:text-5xl font-semibold tracking-tight leading-tight mt-4">
						{isOwnProfile ? 'Your Profile' : `${userData?.username ?? 'User'}'s Profile`}
					</h1>
					<div className="mt-5 h-px w-56 bg-border" />
					<p className="text-foreground/90 mt-5 max-w-2xl text-sm leading-relaxed">
						{isOwnProfile
							? 'Manage your account details, update your password, and view your membership info.'
							: `Viewing ${userData?.username ?? 'this user'}'s public profile.`}
					</p>
				</div>
			</section>

			<main className="max-w-4xl mx-auto px-6 py-10 space-y-10 relative">
				{isOwnProfile && !isEditingUsername && !isEditingPassword && (
					<div className="flex flex-wrap gap-2">
						<button
						onClick={() => { setIsEditingPassword(true) }}
							className="px-3 py-1.5 border border-border bg-surface text-foreground font-mono text-xs uppercase tracking-widest shadow-sm transition-all duration-150 hover:bg-card hover:border-accent/60 hover:text-accent active:translate-y-px active:shadow-none"
						>
							Change Password
						</button>
						<button
						...
						<button
							...
							className="px-3 py-1.5 border border-border bg-surface text-foreground font-mono text-xs uppercase tracking-widest shadow-sm transition-all duration-150 hover:bg-card hover:border-accent/60 hover:text-accent active:translate-y-px active:shadow-none disabled:opacity-50 disabled:cursor-not-allowed"
						>
							...
							<div className="grid grid-cols-1 sm:grid-cols-[120px,1fr] gap-y-3 text-sm">
											...
											<div className="w-full flex flex-col sm:flex-row gap-2">
												...
												<div className="flex gap-2 sm:shrink-0">
													<button
														...
														className="flex-1 sm:flex-initial px-3 py-1.5 border border-accent bg-accent text-white font-mono text-xs uppercase tracking-widest shadow-sm transition-all duration-150 hover:bg-accent/90 active:translate-y-px active:shadow-none"
													>
														Save
													</button>
													<button
														...
														className="flex-1 sm:flex-initial px-3 py-1.5 border border-border bg-surface text-foreground font-mono text-xs uppercase tracking-widest shadow-sm transition-all duration-150 hover:bg-card hover:border-accent/60 active:translate-y-px active:shadow-none"
													>
														Cancel
													</button>
												</div>
											...
											<div className="flex items-center gap-3">
												...
												{isOwnProfile && (
													<button
														...
														className="px-2 py-0.5 border border-border bg-surface text-foreground font-mono text-xs uppercase tracking-widest shadow-sm transition-all duration-150 hover:bg-card hover:border-accent/60 hover:text-accent active:translate-y-px active:shadow-none"
													>
														Edit
													</button>
												)}
								...
								{isOwnProfile && (
									<>
										...
										<div className="text-foreground">{userData.confirmed ? 'Yes' : 'No'}</div>
									</>
								)}
						...
						<div className="border border-border bg-card/80 p-5">
								<div className="flex flex-col gap-3">
										...
										<div className="flex gap-2">
											...
											className={`flex-1 px-4 py-2 border font-mono text-xs uppercase tracking-widest shadow-sm transition-all duration-150
										...
										<button
											...
											className="px-4 py-2 border border-border bg-surface text-foreground font-mono text-xs uppercase tracking-widest shadow-sm transition-all duration-150 hover:bg-card hover:border-accent/60 active:translate-y-px active:shadow-none"
											>
												Cancel
											</button>
										</div>
