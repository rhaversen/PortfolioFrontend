...
const navLinkClass = 'inline-flex items-center gap-1.5 rounded-b-lg border border-t-0 border-border/90 bg-background/90 px-3 py-1 text-[0.7rem] font-mono uppercase tracking-[0.14em] text-foreground shadow-sm transition-colors hover:border-accent hover:text-accent cursor-pointer'
