		...
		<div className="flex flex-col gap-0 border border-border">
			...
			<div className="px-4 pt-4 pb-2 flex justify-end items-end gap-2">
				<textarea
					...
					rows={4}
				className="w-[75%] resize-none border border-border bg-border/20 px-3 py-2 text-sm text-foreground/90 placeholder:text-muted/60 outline-none focus:border-foreground/30 disabled:opacity-40 transition-colors rounded-t-lg rounded-bl-lg"
				/>
			</div>

			<div className="px-4 pt-2 pb-4 flex justify-start items-end gap-2">
				<div
					className="relative w-[75%] border border-border cursor-text overflow-auto rounded-t-lg rounded-br-lg"
