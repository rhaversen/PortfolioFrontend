...
const data: CvData = {
	...
	contacts: [
		...
		{ icon: "flask", text: "interactivematterlab.org", href: "https://interactivematterlab.org" },
	],
	skills: {
		title: "Technical Skills",
		groups: [
			{ heading: "Languages", text: "TypeScript, Python, Java, C++, Bash" },
			{ heading: "Backend", text: "Node.js, Express, REST, WebSockets, MongoDB, Redis, Swagger/OpenAPI, Microservices" },
			{ heading: "Frontend", text: "React, Next.js, Three.js / react-three-fiber" },
			...
			{ heading: "AI/LLM", text: "LLM integration (provider catalogs, caching, agent architectures), sandboxed code execution" },
	...
	intro: [
		"Hi, I'm Rasmus.",
		"I love programming, problem-solving, and anything that can be automated with code, and that's why I love computer science. I learn fast and meet new challenges with curiosity. Any problem can be solved with enough time and the right decomposition; divide and conquer.",
		"But curiosity doesn't stop at a working prototype. What drives me is carrying things all the way from the first idea to a system with real users. I'm a full-stack developer focused on the entire chain, and on-call for everything I build.",
		"Today I'm technical lead in a research setting at Aarhus University, coordinating the development of several systems in daily use at the lab. On the side, I run several production applications with real users on my own infrastructure. My strongest languages are TypeScript and Python, and Linux and Git are daily tools.",
		...
		entries: [
			{
				...
				bullets: [
					"Technical lead for development in the HCI research group. Coordinating and delegating to other developers across several concurrent projects. Co-author on 3 papers submitted to conferences.",
					"Facture: AI-assisted 3D model generation. In-house compiler from LLM-generated design documents to 3D mesh. User-facing agent design system and web interface.",
					"Quickjet: low-level printer firmware. Buffer management and synchronization of G-code and Xaar printhead UART communication.",
					"Systems are in daily use at the lab (silver-printer pipeline, repair workflows).",
				],
			},
			{
