...
const data: CvData = {
	...
	skills: {
		...
		groups: [
			...
			{ heading: "AI/LLM", text: "LLM-integration (provider-kataloger, caching, agent-arkitekturer), sandboxed kodeeksekvering" },
		...
		entries: [
			{
				...
				bullets: [
					"Teknisk lead for udviklingsarbejdet i HCI-forskningsgruppen. Koordinerer og delegerer til andre udviklere på tværs af flere samtidige projekter. Medforfatter på 3 artikler indsendt til konferencer.",
					"Facture: AI-assisteret generering af 3D-modeller. In-house compiler fra LLM-genererede designdokumenter til 3D mesh. Brugervendt agent-designsystem og webinterface",
					"Quickjet: low-level printer-firmware. Bufferhåndtering og synkronisering af G-code og Xaar printhead UART-kommunikation.",
					"Systemerne er i daglig brug på laboratoriet (silver-printer pipeline, repair-arbejdsløsninger)",
				],
			},
			{
